...
class EyeAnalyzer:
    ...
    def analyze(self, image: Image.Image):
        ...
        for center, radius in [(lc, lr), (rc, rr)]:
            ...
            for dx,dy in [(-r-14,0),(-r+8,0),(r-8,0),(r+14,0)]:
                draw.line([cx+dx-6,cy,cx+dx+6,cy], fill=(0,212,255), width=1)
            for dx,dy in [(0,-r-14),(0,-r+8),(0,r-8),(0,r+14)]:
                draw.line([cx,cy+dy-6,cx,cy+dy+6], fill=(0,212,255), width=1)
